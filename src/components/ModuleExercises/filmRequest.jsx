...
const FilmRequest = () => {
    ...
    return (
        <>
            <div>
            <h2 className='filmReqTitle'>Film Request</h2>
            <p className="paragraphFilm">Enter your API Key for OMDB Here</p>
            <input type="text" onChange={(e)=>updateApiKey(e)} />
            <p className="paragraphFilm">Enter the name of the film you are searching for here</p>
            <input type="text" onChange={(e)=>updateTitle(e)} />
            <p className="paragraphFilm">
                Do not click this button until the fields above are correctly filled
            </p>
            <button className='btn1' onClick={(e) => makeReq(e)}>Click me</button>
